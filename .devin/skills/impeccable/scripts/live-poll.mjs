...
Harness note:
  Default one-shot mode is the portable contract for Claude Code, Codex, and devin.
  --stream is experimental for harnesses with fast incremental stdout; do not use on devin.`);
    process.exit(0);
  }
